    ...
    return (
        <section id="contact" className={`${compact ? 'py-8 md:pb-20 md:pt-4' : 'py-10 md:py-16'} bg-white relative overflow-hidden`}>
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                {/* Soft Ambient Glows */}
                <div className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 w-[500px] h-[500px] sm:w-[800px] sm:h-[800px] bg-[#1b5e39]/5 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 w-[400px] h-[400px] sm:w-[600px] sm:h-[600px] bg-[#4ade80]/10 rounded-full blur-3xl"></div>
            </div>

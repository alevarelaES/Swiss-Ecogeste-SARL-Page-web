            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <div className="bg-white/40 backdrop-blur-md p-6 md:p-10 rounded-2xl border border-white/50 text-left w-full">
                        <Reveal>
                            <span className="inline-block text-green-700 font-bold tracking-widest uppercase text-xs bg-green-50 px-4 py-2 rounded-full mb-4">À propos de nous</span>
                            ...
                            <div className="flex flex-wrap gap-4 md:gap-8 justify-between md:justify-start">
                                <div className="flex flex-col items-start min-w-[30%] md:min-w-0">
                                    <span className="text-3xl md:text-4xl font-black text-green-700 mb-2">Local</span>
                                    <span className="text-gray-700 font-semibold text-xs md:text-sm">Action suisse</span>
                                </div>
                                <div className="hidden md:block w-0.5 h-16 bg-gradient-to-b from-green-600 to-green-400"></div>
                                <div className="flex flex-col items-start min-w-[30%] md:min-w-0">
                                    <span className="text-3xl md:text-4xl font-black text-green-700 mb-2">Bio</span>
                                    <span className="text-gray-700 font-semibold text-xs md:text-sm">Écologique</span>
                                </div>
                                <div className="hidden md:block w-0.5 h-16 bg-gradient-to-b from-green-600 to-green-400"></div>
                                <div className="flex flex-col items-start min-w-[30%] md:min-w-0">
                                    <span className="text-3xl md:text-4xl font-black text-green-700 mb-2">Éco</span>
                    ...
                    <div className="relative flex justify-center w-full order-first lg:order-last">
                        <Reveal delay={0.2}>
                            <div className="relative aspect-square bg-white/40 backdrop-blur-lg rounded-3xl overflow-hidden shadow-2xl border-2 border-white/70 w-full max-w-md mx-auto">

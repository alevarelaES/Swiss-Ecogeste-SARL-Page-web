...
const ArticleDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            <header className="pt-32 pb-12 lg:pb-16 bg-gray-100 border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
                        <div>
                            <Reveal>
                                <div className="inline-flex items-center gap-2 bg-green-50 text-[var(--primary)] px-3 py-1 rounded-none text-[10px] font-black uppercase tracking-widest mb-6">
                        ...
                        <div>
                            <Reveal delay={0.2}>
                                <div className="rounded-none overflow-hidden shadow-xl aspect-video relative group">
                                    <div
                        ...
                        <div className="mt-16 pt-12 border-t border-gray-100">
                            ...
                            <div className="flex justify-center gap-3 mb-6">
                                ...
                                <Button
                                    ...
                                    size="default"
                                    className={cn(
                                        "h-10 px-4 flex items-center gap-2 text-[10px] font-black uppercase tracking-wider transition-all",
                                        !copied && "bg-gray-50 text-gray-600 border-gray-100 hover:border-gray-300"
                                    )}
                                >
